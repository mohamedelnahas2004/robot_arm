    ...
    def timer_callback(self):
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                finger_distance = (get_distance(wrist, index_tip) + get_distance(wrist, middle_tip)) / 2.0
                gripper_state = "OPEN"
                if finger_distance < 0.20:
                ...
                # UI Overlay
                cv2.putText(frame, f"Gripper: {gripper_state} | Safety: {safety_state}", (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
